...
/**
 * 线程池异常处理 参考：https://www.cnblogs.com/hapjin/p/10240863.html
 * 
 * @author goldl
 *
 */
public class CustomThreadPoolExecutorTest {
	...
	public static void main(String[] args) throws InterruptedException {
		 ...
		 * 而我们自定义的线程池可以遇到异常可以重新提交该任务 5s后触发关闭任务抛出异常
		 */
		...
		while (!threadPoolExecutor.awaitTermination(1, TimeUnit.SECONDS)) {// 会每隔一秒钟检查一次是否执行完毕（状态为 TERMINATED）
